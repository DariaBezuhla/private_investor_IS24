...
class _HomePage extends State<Home> {
  ...
  final String containerTitle = "Starte deine Suche";
                                ...
                                child: Row(
                                  ...
                                  children: <Widget>[
                                    RawMaterialButton(
                                      ...
                                      child: (_filtersAreVisible == false)
                                          ? Icon(
                                              SystemIconsIS
                                                  .is24_system_48px_add,
                                              color: kCharcoal,
                                          ...
                                          : Icon(
                                              AditionalIconsIS
                                                  .additional_icons_48px_forbidden,
                                              color: kCharcoal,
                                              size: MediaQuery.of(context)
                                                      .size
                                                      .height *
                              ...
                              Container(
                                ...
                                child: ButtonTheme(
                                  ...
                                  child: FlatButton(
                                    ...
                                    child: Text("Suchen", style: styleButton),
                                  ),
                                ),
                              ),
                            ],
